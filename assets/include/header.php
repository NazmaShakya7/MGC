...
<body>
    <div class="uk-offcanvas-content">
        <header class="uk-position-top">
            <div class="uk-main-header uk-navbar-container "
                uk-sticky="top: 100; animation: uk-animation-slide-top-medium;">
                <div class="uk-container">
                    <nav class="uk-navbar uk-position-relative" uk-navbar
                        uk-scrollspy="target:.uk-navbar-item; cls: uk-animation-slide-top-medium;   delay: 50; repeat: true;">
                        <div class="uk-navbar-left  ">
                            <div class="uk-navbar-item">
                                <a class="uk-navbar-toggle" uk-navbar-toggle-icon
                                    uk-toggle="target: #uk-menu; animation: uk-animation-slide-top ; queued: false; duration: 600"></a>
                            </div>
                        </div>
        ...
        <div id="uk-menu" uk-offcanvas>
            <div class="uk-offcanvas-bar uk-padding-remove uk-dark">
                <button class="uk-offcanvas-close " type="button" style="color:var(--primary)!important;"
                    uk-close></button>
                ...
                <nav class="uk-card-small uk-card-body uk-nav-small">
                    <ul class="uk-nav-default offcanvas-font" uk-nav>
                        ...
                        <div class=" uk-margin-medium  uk-margin-remove-horizontal" style="height:1px; background:#d2563669;"></div>

                        <div class="off-canvas-icon uk-text-center">
